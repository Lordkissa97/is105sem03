...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		{inputMessage: []rune("bnizmoNcd7;484N5: 47 6466a45S94N."), chiffer: len(AlfSem03) - 4, want: []rune("Kjevik;SN39040;18.03.2022 01:50;6")},
	}
...
func TestSokIAlfabetet(t *testing.T) {
	...
	for _, tc := range tests {
		got := sokIAlfabetet(tc.input, AlfSem03)
		if got != tc.want {
